...
impl Cudnn {
    ...
    where T: Float + DataTypeInfo {
        API::rnn_forward_training(
            ...
            *rnn_config.sequence_length(),
            (&tensor_vec_id_c(&src_desc)).as_ptr(),
            src,
            *hidden_desc.id_c(),
            hidden,
            *cell_desc.id_c(),
    ...
    pub fn rnn_backward_data<T>(
        ...
        final_hidden_gradient_desc: TensorDescriptor,
        final_hidden_gradient: *const ::libc::c_void,
        final_cell_gradient_desc: TensorDescriptor,
        final_cell_gradient: *const ::libc::c_void,
        weight_desc: &FilterDescriptor,
        weight: *const ::libc::c_void,
        inital_hidden_desc: TensorDescriptor,
        initial_hidden: *const ::libc::c_void,
        initial_cell_desc: TensorDescriptor,
        initial_cell: *const ::libc::c_void,
        input_gradient_desc: Vec<TensorDescriptor>,
        input_gradient: *mut ::libc::c_void,
        initial_hidden_gradient_desc: TensorDescriptor,
        initial_hidden_gradient: *mut ::libc::c_void,
        initial_cell_gradient_desc: TensorDescriptor,
        initial_cell_gradient: *mut ::libc::c_void,
        workspace: *mut ::libc::c_void,
        ...
        API::rnn_backward_data(
            ...
            *rnn_config.sequence_length(),
            ...
            output_gradient,
            *final_hidden_gradient_desc.id_c(),
            final_hidden_gradient,
            *final_cell_gradient_desc.id_c(),
            final_cell_gradient,
            *weight_desc.id_c(),
            weight,
            *inital_hidden_desc.id_c(),
            initial_hidden,
            *initial_cell_desc.id_c(),
            initial_cell,
            tensor_vec_id_c(&input_gradient_desc).as_slice().as_ptr(),
            input_gradient,
            *initial_hidden_gradient_desc.id_c(),
            initial_hidden_gradient,
            *initial_cell_gradient_desc.id_c(),
            initial_cell_gradient,
            workspace,
            rnn_config.rnn_workspace_size(),
